...
npm install -D babel-plugin-transform-object-spread-inline
...
npm install -S react react-redux redux react-router-redux redux-promise-middleware redux-thunk
